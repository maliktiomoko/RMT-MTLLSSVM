...
switch data
    case 'Ca-W'
        S=load('Caltech10_zscore_SURF_L10.mat');
        T=load('webcam_zscore_SURF_L10.mat');
Xsr=S.Xt; ysr=S.Yt;
Xsr = Xsr';
...
Xtar = Xtar';
    case 'W-Ca'
        S=load('webcam_zscore_SURF_L10');
        T=load('Caltech10_zscore_SURF_L10.mat');
Xsr=S.Xt; ysr=S.Yt;
Xsr = Xsr';
...
Xtar = Xtar';
    case 'Ca-A'
        S=load('Caltech10_zscore_SURF_L10.mat');
        T=load('amazon_zscore_SURF_L10.mat');
Xsr=S.Xt; ysr=S.Yt;
Xsr = Xsr';
...
Xtar = Xtar';
    case 'A-Ca'
        S=load('amazon_zscore_SURF_L10.mat');
        T=load('Caltech10_zscore_SURF_L10.mat');
Xsr=S.Xt; ysr=S.Yt;
Xsr = Xsr';
...
Xtar = Xtar';
    case 'Ca-D'
        S=load('Caltech10_zscore_SURF_L10.mat');
        T=load('dslr_zscore_SURF_L10.mat');
Xsr=S.Xt; ysr=S.Yt;
Xsr = Xsr';
...
Xtar = Xtar';
    case 'D-Ca'
        S=load('dslr_zscore_SURF_L10.mat');
        T=load('Caltech10_zscore_SURF_L10.mat');
Xsr=S.Xs; ysr=S.Ys;
Xsr = Xsr';
...
Xtar = Xtar';
    case 'W-A'
        S=load('webcam_zscore_SURF_L10.mat');
        T=load('amazon_zscore_SURF_L10.mat');
Xsr=S.Xt; ysr=S.Yt;
Xsr = Xsr';
...
%save(strcat(data, '_Split_', num2str(gt), '.mat'),'trainData','testData')
save([pwd '/utils/Functions/Data/' data '_Split_' num2str(gt) '.mat'],'trainData','testData')
